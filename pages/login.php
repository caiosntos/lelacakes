...
<html lang="pt-BR">
  ...
  <body
    class="bg-gradient-to-br from-white via-white to-white font-sans min-h-screen"
  >
    <nav
      class="fixed w-full top-0 z-50 backdrop-blur-md bg-white/90 border-b border-white/30 shadow-lg"
    >
    ...
    <div class="pt-28 pb-16">
      <div class="max-w-6xl mx-auto px-8">
        ...
        <div class="grid grid-cols-2 gap-12 items-start">
          <div
            class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-10 border border-white/50 hover:shadow-3xl transition-all duration-500"
          >
            <div class="text-center mb-8">
              <div
                class="w-16 h-16 bg-cake-red rounded-full flex items-center justify-center mx-auto mb-4"
              >
            ...
            <form class="space-y-6">
              ...
              <button
                type="submit"
                class="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold py-4 rounded-2xl text-lg transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
              ...
              <a
                href="#"
                class="block text-center text-cake-red hover:text-red-700 font-medium transition-colors duration-300"
          ...
          >
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
              <button
                class="w-full flex items-center justify-center px-6 py-4 border-2 border-gray-200 rounded-2xl hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 group"
              >
                <img
                ...
                />
                <span
                  class="text-gray-700 font-medium group-hover:text-gray-800"
                  >Conecte-se com Google</span
                >
              </button>
            </div>
          </div>
    ...
    >
      ...
      >
        <div
          class="flex justify-between items-center p-8 border-b border-gray-200"
        >
          <div class="flex items-center space-x-3">
            <div
              class="w-12 h-12 bg-gradient-to-r from-cake-pink to-orange-400 rounded-full flex items-center justify-center"
            >
          ...
          <button
            onclick="closeModal1()"
            class="text-gray-400 hover:text-gray-600 text-3xl font-light transition-colors duration-300"
          >
            &times;
          </button>
        </div>
        ...
        <div
          class="flex justify-end space-x-4 p-8 border-t border-gray-200 bg-gray-50/50"
        >
          <button
            onclick="closeModal1()"
            class="px-8 py-3 text-gray-600 border-2 border-gray-300 rounded-xl font-medium hover:bg-gray-100 hover:border-gray-400 transition-all duration-300"
          >
            Cancelar
          </button>
          <button
            type="submit"
            class="px-8 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-xl font-bold transform hover:scale-105 transition-all duration-300 shadow-lg"
          >
            Salvar Registro
          </button>
        </div>
