    ...
    <main class="pt-28 pb-16">
        <div class="max-w-6xl mx-auto px-8">
            <div class="mb-12 text-center">
                <h1 class="text-5xl font-serif font-bold text-gray-800 mb-4">Meu Carrinho</h1>
                <div class="w-20 h-1 bg-gradient-to-r from-red-500 to-red-700 mx-auto"></div>
            </div>
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-3xl shadow-xl p-6 transform hover:scale-[1.02] transition-all duration-300">
                        <div class="flex items-center space-x-6">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-serif font-bold text-gray-800 mb-2">Bolo de Chocolate</h3>
                                <p class="text-gray-600 mb-3">Delicioso bolo com cobertura cremosa</p>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <button onclick="updateQuantity('item1', -1)" 
                                        ...
                                        <span id="qty-item1" class="text-xl font-bold text-gray-800 min-w-8 text-center">2</span>
                                        <button onclick="updateQuantity('item1', 1)" 
                                                class="w-10 h-10 rounded-full bg-red-100 hover:bg-red-200 flex items-center justify-center text-red-500 font-bold transition-all duration-300">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button onclick="removeItem('item1')" 
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-6 transform hover:scale-[1.02] transition-all duration-300">
                        <div class="flex items-center space-x-6">
                            <img src="https://images.unsplash.com/photo-1607478900766-efe13248b125?w=120&h=120&fit=crop" 
                                 class="w-24 h-24 rounded-2xl object-cover shadow-lg" 
                                 alt="Bolo de Rolo">
                            <div class="flex-1">
                                <h3 class="text-2xl font-serif font-bold text-gray-800 mb-2">Bolo de Rolo</h3>
                                <p class="text-gray-600 mb-3">Tradicional bolo nordestino com goiabada</p>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <button onclick="updateQuantity('item2', -1)" 
                                                class="w-10 h-10 rounded-full bg-red-100 hover:bg-red-200 flex items-center justify-center text-red-500 font-bold transition-all duration-300">
                                            <i class="bi bi-dash"></i>
                                        </button>
                                        <span id="qty-item2" class="text-xl font-bold text-gray-800 min-w-8 text-center">1</span>
                                        <button onclick="updateQuantity('item2', 1)" 
                                                class="w-10 h-10 rounded-full bg-red-100 hover:bg-red-200 flex items-center justify-center text-red-500 font-bold transition-all duration-300">
                                            <i class="bi bi-plus"></i>
                                        </button>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button onclick="removeItem('item2')" 
                                                class="text-red-400 hover:text-red-600 text-sm mt-1 transition-colors duration-300">
                                            <i class="bi bi-trash mr-1"></i> Remover
                                        </button>
                                    </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-6 transform hover:scale-[1.02] transition-all duration-300">
                        <div class="flex items-center space-x-6">
                            <img src="https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=120&h=120&fit=crop" 
                                 class="w-24 h-24 rounded-2xl object-cover shadow-lg" 
                                 alt="Docinhos">
                            <div class="flex-1">
                                <h3 class="text-2xl font-serif font-bold text-gray-800 mb-2">Docinhos Variados</h3>
                                <p class="text-gray-600 mb-3">Brigadeiro, beijinho e surpresa de uva</p>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <button onclick="updateQuantity('item3', -1)" 
                                                class="w-10 h-10 rounded-full bg-red-100 hover:bg-red-200 flex items-center justify-center text-red-500 font-bold transition-all duration-300">
                                            <i class="bi bi-dash"></i>
                                        </button>
                                        <span id="qty-item3" class="text-xl font-bold text-gray-800 min-w-8 text-center">3</span>
                                        <button onclick="updateQuantity('item3', 1)" 
                                                class="w-10 h-10 rounded-full bg-red-100 hover:bg-red-200 flex items-center justify-center text-red-500 font-bold transition-all duration-300">
                                            <i class="bi bi-plus"></i>
                                        </button>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button onclick="removeItem('item3')" 
                                                class="text-red-400 hover:text-red-600 text-sm mt-1 transition-colors duration-300">
                                            <i class="bi bi-trash mr-1"></i> Remover
                                        </button>
                                    </div>
                ...
                <div class="space-y-8">
                    <div class="bg-white rounded-3xl shadow-xl p-8 sticky top-32">
                        <h2 class="text-3xl font-serif font-bold text-gray-800 mb-6 flex items-center">
                        ...
                        <div class="border-t-2 border-gray-200 pt-6 mb-8">
                            <div class="flex justify-between items-center">
                                ...
                                <span id="total" class="text-3xl font-bold gradient-text">R$70</span>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-4 text-center">
                            <div class="flex items-center justify-center space-x-2 text-green-600">
                                <i class="bi bi-shield-check text-xl"></i>
                                <span class="font-semibold">Compra 100% Segura</span>
                            </div>
                            <p class="text-green-600 text-sm mt-1">SSL e dados protegidos</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-8">
            <div class="text-center">
                <div class="flex justify-center space-x-8 mb-8">
                    <a href="#" class="bg-red bg-opacity-10 hover:bg-red-500 p-4 rounded-full text-2xl transition-all duration-300 hover:scale-110">
